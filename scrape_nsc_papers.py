...
SUBJECT_MAP = [
    ...
    ("tourism",                         "tour"),
    ("music",                           "music"),
    # Languages — HL/FAL variants before plain name
    ("english_fal",                     "eng_fal"),
    ("english_hl",                      "eng_hl"),
    ("english_sal",                     "eng_fal"),   # SAL treated as FAL
    ("afrikaans_fal",                   "afr_fal"),
    ("afrikaans_hl",                    "afr_hl"),
    ("afrikaans_sal",                   "afr_fal"),
    ("isizulu_fal",                     "zul_fal"),
    ("isizulu_hl",                      "zul_hl"),
    ("isizulu_sal",                     "zul_fal"),
    ("isizulu",                         "zul_fal"),
    ...
    ("sesotho_hl",                      "sot_hl"),
    ("sesotho",                         "sot_fal"),
    ("setswana_fal",                    "sot_fal"),
    ("setswana_hl",                     "sot_hl"),
    ("setswana",                        "sot_fal"),
    ("afrikaans",                       "afr_fal"),
    # NOTE: plain "english" intentionally omitted —
    # it appears as a language tag in every filename (e.g. "Accounting_P1_English.pdf")
    # English papers are caught above via "english_fal" / "english_hl" / "english_sal"
]
